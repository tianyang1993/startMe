...
package com.example.startme.app.other.gpucamera;
...
public class GPUImageFilterTools {  
    ...
    public static void selectFilter(final Context context, final int index,
                                  final OnGpuImageFilterChosenListener listener){
        ...
        listener.onGpuImageFilterChosenListener(createFilterForType(context, filters.filters.get(index)));
    }
